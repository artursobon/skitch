...
{ 
    SkitchImageProfileLossless,        // PNG
    SkitchImageProfileCompressed,      // JPG
    SkitchImageProfileCompressedHEIC   // HEIC
} SkitchImageProfile;
...
SkitchImageProfile SkitchImageFileURLProfile(NSURL* url);
